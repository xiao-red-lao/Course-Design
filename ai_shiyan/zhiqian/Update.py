from tkinter import *
from zhiqian import database as up
...
class Update:
    def __init__(self):
        ...
        def Up():
            ...
            up.Update(sid, sname, sage, sgender, scla, sphone, saddress)
        ...
        Button(root, text='修改', width=10, command=Up).grid(row=7, column=0, sticky=W, padx=10, pady=5)
